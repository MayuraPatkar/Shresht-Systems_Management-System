                        ...
                        <section class="border-r border-slate-200 overflow-y-auto p-6 bg-white flex flex-col">
                            <form id="voucher-form" class="space-y-5 flex-grow">
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    <label class="text-xs font-semibold text-slate-600">Payee Type <span class="text-red-500">*</span><select id="v-form-party-type" required class="mt-1 w-full px-3 py-2.5 border border-slate-300 rounded-lg text-sm bg-white"><option selected>Customer</option><option>Supplier</option><option>Other</option></select></label>
                                    <div class="col-span-2 relative z-30" id="v-party-search-container"><label class="text-xs font-semibold text-slate-600"><i class="fas fa-search text-gray-500 mr-1"></i>Search Recipient <span class="text-red-500">*</span><input type="text" id="v-form-party-name" required autocomplete="off" placeholder="Search by name, phone, email, or GSTIN..." class="mt-1 w-full px-3 py-2.5 border border-slate-300 rounded-lg text-sm"></label><input type="hidden" id="v-form-party-id"><ul id="v-party-suggestions" class="suggestions hidden absolute top-full left-0 mt-1 z-50 w-full bg-white border border-gray-200 rounded-lg shadow-lg max-h-48 overflow-y-auto"></ul></div>
                                </div>
                                <div id="v-party-profile-card-container" class="mt-2 hidden"></div>
                                <div class="grid grid-cols-3 gap-3">
